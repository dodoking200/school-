...
export const TeachersColorIcon = ({ className = "", size = 20 }: IconProps) => (
  ...
  >
    ...
    <path
      d="M4.26 14C4.09 15.42 4 16.91 4 18.5C4 19.33 4.67 20 5.5 20S7 19.33 7 18.5C7 16.91 6.91 15.42 6.74 14M12 7L12 2M18 7L14 7.5L12 7L10 7.5L6 7C6 9.76142 8.23858 12 11 12H13C15.7614 12 18 9.76142 18 7ZM22 7C22 10.866 18.866 14 15 14M2 7C2 10.866 5.134 14 9 14M15 18.5C15 16.91 15.09 15.42 15.26 14M20 18.5C20 19.33 19.33 20 18.5 20S17 19.33 17 18.5C17 16.91 17.09 15.42 17.26 14"
      stroke="url(#teachersGradient)"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
...
export const BuildingColorIcon = ({ className = "", size = 20 }: IconProps) => (
  ...
  >
    ...
    <path
      d="M6 22V4C6 2.89543 6.89543 2 8 2H16C17.1046 2 18 2.89543 18 4V22M6 22H18M6 22H2M18 22H22"
      stroke="url(#buildingGradient)"
      strokeWidth="2"
      strokeLinecap="round"
    />
    <path
      d="M10 6H14M10 10H14M10 14H14"
      stroke="url(#buildingGradient)"
      strokeWidth="2"
      strokeLinecap="round"
    />
...
export const AttendanceColorIcon = ({
  className = "",
  size = 20,
}: IconProps) => (
  <svg
...
// Currency Dollar Icon - Green gradient
export const CurrencyDollarColorIcon = ({
  className = "",
  size = 20,
}: IconProps) => (
  <svg
  ...
  >
    ...
    <path
      d="M12 1V23"
      stroke="url(#currencyDollarGradient)"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
...
// Upload Icon - Blue gradient
export const UploadColorIcon = ({ className = "", size = 20 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Download Icon - Green gradient
export const DownloadColorIcon = ({ className = "", size = 20 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Close Icon - Red gradient
export const CloseColorIcon = ({ className = "", size = 20 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
