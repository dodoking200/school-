...
export default function ContactUs() {
  return (
    <section className="py-12 min-h-[750px] m-10 md:py-20 bg-gray-100">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className=" flex-row gap-8 md:gap-12 items-start">
          ...
          <div className="mt-8 md:mt-0">
            <div className="bg-gray-200 h-80 md:h-96 rounded-lg shadow-md flex items-center justify-center">
